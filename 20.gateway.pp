class { 
 'ffnord::params':
  router_id      => "10.187.81.1", # The id of this router, probably the ipv4 address
...
ffnord::mesh { 
 'mesh_ffnord':
  ...
  , mesh_code       => "ffnord"
  , mesh_as         => "65187"
  , mesh_mac        => "fe:ed:be:ef:ff:20"
  , vpn_mac         => "fe:ed:be:ff:ff:20"
  , mesh_ipv6       => "fd42:eb49:c0b5:4242::fd20/64"
  , mesh_ipv4       => "10.187.81.1/17"
  , range_ipv4      => "10.187.0.0/16"
  , mesh_mtu        => "1280"
  , mesh_peerings   => "/root/mesh_peerings.yaml"
 
  , fastd_secret    => "/root/nord-gw20-fastd-secret.key"
  , fastd_port      => 10050
  , fastd_peers_git => 'git@gitlab.com:ffnord/nord-ffffng-keys.git'
 
  , dhcp_ranges     => ['10.187.81.2 10.187.84.254']
  , dns_servers     => ['10.187.81.1'] # should be the same as $router_id
}
